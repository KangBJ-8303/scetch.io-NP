...
public class ChatMsg implements Serializable {
    ...
    public static final int MODE_ENTER = 4;
    public static final int MODE_TX_STRING = 16;
    public static final int MODE_TX_IMAGE = 64;
    public static final int MODE_TX_DRAW = 128;
    public static final int MODE_TX_USER = 153;
    public static final int MODE_TX_ORDER = 256;
    public static final int MODE_TX_START = 512;
    public static final int MODE_TX_CORRECT = 48;
    public static final int MODE_TX_USERSCORE = 32;
    public static final int MODE_TX_END = 80;
    public static final int MODE_TX_RESET = 96;
    String userID;
    int mode;
    String message;
    BufferedImage image;
    ...
    public ChatMsg(String userID, int code) {
        this(userID, code, (String)null, (BufferedImage)null);
    }

    public ChatMsg(String userID, int code, String message) {
        this(userID, code, message, (BufferedImage)null);
    }

    public ChatMsg(String userID, int code, BufferedImage image) {
        this(userID, code, (String)null, image);
    }

    public ChatMsg(String userID, int code, String filename, long size) {
        this(userID, code, filename, (BufferedImage)null, size);
    }
}
